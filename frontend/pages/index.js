...
export default function Home() {
    ...
    const { walletConnected, setWalletConnected, web3ModalRef, getProviderOrSigner } = context;
            ...
            <>
                <div>
                    ...
                    <div className={styles.description}>
                        Get on the whitelist for early access to minting CryptoDevs NFTs.
                    </div>
                    <div className={styles.description}>
                        So far {numberOfWhitelisted} have already joined the Whitelist
                    </div>
